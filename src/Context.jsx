...
const ContextProvider = ({ children }) => {
    ...
    useEffect(() => {
      ...
      .then(([
        ...
        {data: popular},
        {data: upcomings},
        {data: topRated}] ) => ( setMovies(movies.results), setPopular(popular.results), setUpcomings(upcomings.results), setTopRated(topRated.results) )); 
  ...
  return (
    <Context.Provider value={{ movies, popular, upcomings, IMAGE_PATH, topRated, test, setTest }}>
      {children}
    </Context.Provider>
  );
};
